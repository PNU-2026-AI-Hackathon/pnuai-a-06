...
const styles = StyleSheet.create({
  overlay: { backgroundColor: 'rgba(0, 0, 0, 0.22)', flex: 1, justifyContent: 'flex-end' },
  sheet: { backgroundColor: '#ffffff', borderTopLeftRadius: 28, borderTopRightRadius: 28, paddingTop: 26 },
  sheetTitle: { color: '#10161F', fontSize: 21, fontWeight: '700', marginBottom: 26 },
  calendarHeader: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' },
  monthTitle: { color: '#10161F', fontSize: 17, fontWeight: '700' },
  monthButtons: { flexDirection: 'row', gap: 12 },
  monthButton: { alignItems: 'center', height: 32, justifyContent: 'center', width: 32 },
  monthButtonText: { color: '#10161F', fontSize: 34, lineHeight: 28 },
  disabledMonthButtonText: { color: '#D8E0E4' },
  weekdayRow: { flexDirection: 'row', marginTop: 20 },
  weekdayText: { color: '#303940', flex: 1, fontSize: 12, textAlign: 'center' },
  calendarGrid: { flexDirection: 'row', flexWrap: 'wrap', marginTop: 4, minHeight: 264 },
  dayCell: { alignItems: 'center', height: 48, justifyContent: 'center', width: '14.2857%' },
  rangeFill: { backgroundColor: '#D4E7F0', bottom: 3, left: 0, position: 'absolute', right: 0, top: 3 },
  rangeStart: { borderBottomLeftRadius: 28, borderTopLeftRadius: 28, left: 0 },
  rangeEnd: { borderBottomRightRadius: 28, borderTopRightRadius: 28, right: 0 },
  dayText: { color: '#222B31', fontSize: 15, zIndex: 1 },
  outsideMonthText: { color: '#D8E0E4' },
  disabledDayText: { color: '#D8E0E4' },
  selectedDayText: { color: '#10161F', fontWeight: '600' },
  confirmButton: {
    alignItems: 'center',
    borderRadius: 42,
    height: 63,
